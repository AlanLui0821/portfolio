  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      if (threeRef.current) {
        ...
        if (t.onPointerMove) window.removeEventListener('pointermove', t.onPointerMove);
      ...
      // Listen to window events to track mouse even if covered by other elements
      ...
      threeRef.current = {
        ...
        touch,
        liquidEffect,
        onPointerDown, // Store references to clean up
        onPointerMove
      };
    } else {
      const t = threeRef.current!;
